...
export function EmailVerificationHtml(url: string): string {
    return `  <title>Verify your email address</title>
  <head>
    <style>
      /* Base ------------------------------ */
                    ...
                    <td class="content-cell">
                      ...
                      <table class="body-action" align="center" width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="center">
                            <div>
                              <a href="https://www.digiresumes.com/api/user/verify/${url}" class="button button--blue">Verify Email</a>
                            </div>
                          </td>
                        </tr>
                      </table>
                      ...
                      <table class="body-sub">
                        <tr>
                          <td>
                            ...
                            <p class="sub"><a href="https://www.digiresumes.com/api/user/verify/${url}">Click here</a></p>
                          </td>
                        </tr>
                      </table>
                    </td>
